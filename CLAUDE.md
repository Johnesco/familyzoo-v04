# Family Zoo — v04 — Portable Objects — Claude Project Memory
...
**Name:** Family Zoo — v04 — Portable Objects
**Purpose:** Sharpee tutorial step 4 — Portable Objects.
...
**Repository:** https://github.com/Johnesco/familyzoo-v04
**Live:** https://johnesco.github.io/familyzoo-v04/
...
├── familyzoo-04.js         the built story bundle
...
The steps are **generated**, not hand-edited: each one is `familyzoo.story` sliced to the blocks introduced at or before this step, with per-step room prose so a description never names a thing the step has not created yet. Change the master and the step map, then re-lay the steps — do not hand-edit `familyzoo-v04.story`.
